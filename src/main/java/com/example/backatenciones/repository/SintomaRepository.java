...
@Repository
public interface SintomaRepository extends CrudRepository<Sintoma, UUID> {
    //Sintoma findOneById(String id);
    //Sintoma findAllByDoctipoAndDocnum(String doctipo, String docnum);
