...
@Repository
public interface AcompananteRepository extends CrudRepository<Acompanante, UUID> {
    //Acompanante findOneById(String id);
    // Acompanante findAllByDoctipoAndDocnum(String doctipo, String docnum);
